                  ...
                  <div key={u.id} className={cn(
                    ...
                    {expandedUser === u.id && (
                      <div className="px-3 sm:px-4 pb-3 sm:pb-4 border-t border-border/50 pt-3 space-y-3">
                        ...
                        {/* ID Verification info — always shown */}
                        {(() => {
                          const verif = verifs.find((v) => v.user_id === u.id);
                          return (
                            <div className={cn(
                              'rounded-xl border p-3 space-y-2',
                              verif ? 'border-border bg-white/5' : 'border-dashed border-border/50 bg-white/3'
                            )}>
                              ...
                              {verif ? (
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  {verif.id_number ? (
                                    <span className="text-xs text-white font-mono bg-white/5 px-2 py-1 rounded-lg border border-border select-all">
                                      {verif.id_number}
                                    </span>
                                  ) : (
                                    <span className="text-xs text-muted italic">No ID number provided</span>
                                  )}
                                ...
                                <p className="text-xs text-muted/60 italic">No ID document submitted</p>
                              )}
                            </div>
                          );
                        })()}
