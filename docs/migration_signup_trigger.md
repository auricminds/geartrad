# GearTrad — Signup Trigger + Admin Migration

Run this in **Supabase Dashboard → SQL Editor**. Paste the whole block and click Run.
...
After running, paste this to confirm both admins are set:
